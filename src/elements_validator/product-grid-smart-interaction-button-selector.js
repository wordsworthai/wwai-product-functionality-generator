export function validateProductGridIconSmartInteractionButton(element, printToLogs = false) {
    const messages = [];
    let hasError = false;
    ...
    if (printToLogs) {
        console.group(`[validateProductGridIconSmartInteractionButton] Validation Output`);
